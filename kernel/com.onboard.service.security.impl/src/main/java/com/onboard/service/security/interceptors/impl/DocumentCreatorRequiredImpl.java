...
import com.onboard.service.security.interceptors.DocumentCreatorRequired;

@Service("documentCreatorRequiredBean")
public class DocumentCreatorRequiredImpl extends BasicIdentifiableInterceptor implements DocumentCreatorRequired {
